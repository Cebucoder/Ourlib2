...
$query = "SELECT * FROM snippet_code WHERE category = 'images'";
...
<!-- Images -->
<div class="prev_con images">
    <div class="heading_con">
        <h2 class="heading_def">Images</h2>
    </div>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="output_viewer">
                    ...
                    <div class="preview_con">
                        <figure>
                            <img src="<?php echo htmlspecialchars($row['file_path']); ?>" alt="Uploaded images Image">
                        </figure>
                    </div>
                </div>
            <?php endwhile; ?>
