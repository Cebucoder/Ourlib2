...
$query = "SELECT * FROM snippet_code WHERE category = 'boxes'";
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="output_viewer">
                    ...
                    <div class="preview_con">
                        <figure>
                            <img src="<?php echo htmlspecialchars($row['file_path']); ?>" alt="Uploaded boxes Image">
                        </figure>
                    </div>
                </div>
            <?php endwhile; ?>
