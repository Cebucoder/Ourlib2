...
$query = "SELECT * FROM snippet_code WHERE category = 'banner'";
                ...
                <div class="output_viewer">
                    <div class="code_viewer_header">
                        ...
                        <div class="head_source_con">
                            ...
                            <span>
                                <a href="<?php echo htmlspecialchars($row['file_path']); ?>" target="_blank" title="Source Code">
                    ...
                    <div class="preview_con">
                        <figure>
                            <img src="<?php echo htmlspecialchars($row['file_path']); ?>" alt="Uploaded banner Image">
                        </figure>
                    </div>
                </div>
            <?php endwhile; ?>
