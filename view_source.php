...
include 'includes/back_home.php';
...
<div class="main_con">
        <div class="wrapper">
            ...
            <?php endif; ?>
                ...
                <div class="dependencies_con">
                <textarea name="" id="ex_dep" rows="10" readonly></textarea>
                </div>
...
<script>
    // Define the external dependencies as a string with escaped backticks
    const externalDependencies = `<script type="module" src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.esm.js"></script>
<script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>`;

    // Set the content of the textarea using innerText to preserve formatting
    let extDep = document.getElementById('ex_dep');
    extDep.innerText = externalDependencies; // Populate the textarea
</script>
